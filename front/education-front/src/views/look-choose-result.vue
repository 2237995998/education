    ...
    <div>
        <el-table
            ...
            <el-table-column
                    ...
                    align="center">
                <template slot-scope="scope">
                    <el-button @click="dropCourse(scope.row.course.courseId)" type="text" size="small">退课</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    export default {
        ...
        methods: {
            ...
            getList() {
                this.$axios.get("/course/showResult?pageNum=" + this.pageNum + '&pageSize=' + this.pageSize
